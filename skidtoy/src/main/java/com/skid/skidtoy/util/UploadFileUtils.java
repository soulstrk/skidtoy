...
public class UploadFileUtils {
	...
	public static Map<String, String> uploadFile(String uploadPath, String originalName, byte[] fileData) throws Exception {
		...
		// 파일의 확장자에 따라 썸네일(이미지 일경우) 또는 아이콘을 생성함.
